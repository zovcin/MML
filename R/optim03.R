...
hfn <- function(x) {
  g <- c(
    2 + (3 / 5) * x[1] + (3 / 5) * x[2] + (3 / 5) * x[3] + (3 / 5) * x[4] + (3 / 25) * (x[1] + x[2] + x[3] + x[4])^2, 2 + (3 / 5) * x[1] + (3 / 5) * x[2] + (3 / 5) * x[3] + (3 / 5) * x[4] + (3 / 25) * (x[1] + x[2] + x[3] + x[4])^2, 2 + (3 / 5) * x[1] + (3 / 5) * x[2] + (3 / 5) * x[3] + (3 / 5) * x[4] + (3 / 25) * (x[1] + x[2] + x[3] + x[4])^2, 2 + (3 / 5) * x[1] + (3 / 5) * x[2] + (3 / 5) * x[3] + (3 / 5) * x[4] + (3 / 25) * (x[1] + x[2] + x[3] + x[4])^2,
